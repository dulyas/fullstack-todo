...
export const registration = async (email: string, password: string): Promise<UserWithTokens> => {
    ...
    const user = await User.query().insertAndFetch({email, password: hashPassword})
...
export const login = async (email: string, password: string): Promise<UserWithTokens> => {
